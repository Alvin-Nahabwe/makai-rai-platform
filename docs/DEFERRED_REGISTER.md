...
| D-044 | SSO / OAuth / passwordless as an adoption lever | PARKED | 2026-08-02 | Credentials-only. Primary adopter is university teams, where institutional SSO (Shibboleth/SAML, Google Workspace) is frequently a **procurement precondition**, not a preference. Cheapest moment to add a provider is Plan 1b, when registration is already being rewritten | Plan 1b auth rewrite — decide before building registration | Phase 1b decision | Open |
